...
public class Sorting {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Среднее время сортировки пузырьком составляет: " + timeForBubbleSort + " мс");
        double timeForSelectionSort = timeForSelectionSort(5);
        System.out.println("Среднее время сортировки выбором составляет: " + timeForSelectionSort + " мс");
        double timeForInsertionSort = timeForInsertionSort(5);
        System.out.println("Среднее время сортировки вставками составляет: " + timeForInsertionSort + " мс");
    }
